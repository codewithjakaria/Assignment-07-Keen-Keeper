export default function FriendCard({ friend }) {
  ...
  return (
    <div className="bg-white rounded-[32px] shadow-sm p-6 flex flex-col items-center hover:shadow-md transition-all border border-gray-50">
      {/* Profile Image */}
      ...
      {/* Days ago */}
      <p className="text-gray-400 text-[13px] mt-1 font-medium">62d ago</p>
