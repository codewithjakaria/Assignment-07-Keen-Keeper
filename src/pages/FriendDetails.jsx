    ...
    <div className="bg-[#F8FAFC] min-h-screen py-16 px-4">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 items-stretch">
        <div className="w-full lg:w-[380px] bg-white rounded-[24px] shadow-sm border border-gray-100 p-10 flex flex-col items-center justify-between">
          <div className="w-full flex flex-col items-center">
            ...
            <div className="flex flex-col items-center gap-2 mt-2">
              <span
                className={`px-5 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest text-white ${statusColors[friend.status] || statusColors.default}`}
              >
                {friend.status}
              </span>
            ...
            <p className="text-center text-gray-400 italic mt-8 text-[14px]">
              "{friend.bio}"
            </p>
          </div>

          <div className="mt-10 w-full space-y-3">
            <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-100 py-4 rounded-2xl text-[13px] font-bold hover:bg-gray-50 transition shadow-sm">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 flex divide-x divide-gray-100 overflow-hidden text-center">
            <div className="flex-1 py-12">
              <p className="text-5xl font-bold text-[#1A1A1A]">
                {friend.days_since_contact}
              </p>
              <p className="text-[11px] text-gray-400 mt-3 font-bold uppercase tracking-widest">
                Days Since
              </p>
            </div>
            <div className="flex-1 py-12">
          ...
          <div className="bg-white rounded-[24px] p-10 shadow-sm border border-gray-100 flex justify-between items-center">
            ...
            <button className="text-[11px] font-bold text-gray-400 bg-gray-50 px-6 py-2.5 rounded-xl border border-gray-100 hover:bg-gray-100 uppercase">
              Edit
            </button>
          </div>
            ...
            <div className="grid grid-cols-3 gap-6 h-[calc(100%-40px)]">
              {actions.map(action => (
                <button
                  ...
                  className="bg-[#F8FAFC] rounded-[28px] flex flex-col items-center justify-center gap-4 hover:bg-white hover:border-gray-100 border border-transparent transition group"
                >
                  <img src={action.img} className="w-10 h-10 object-contain" />
                  <span className="text-[12px] font-bold text-gray-400 uppercase tracking-widest group-hover:text-gray-700">
                    {action.name}
                  </span>
                </button>
              ))}
